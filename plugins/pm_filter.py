...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                InlineKeyboardButton('support', url='https://t.me/universalmuvies'),
                InlineKeyboardButton('channel', url='https://t.me/+_n5WfFVMoadmOTY9')
            ],
            [
                InlineKeyboardButton('Series & Movie Club', url=f'https://t.me/+_n5WfFVMoadmOTY9')
            ]
            ]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('updates', url='https://t.me/universalmuvies'),
            InlineKeyboardButton('movie club', url='https://t.me/+_n5WfFVMoadmOTY9')
            ],[
...
async def auto_filter(client, msg, spoll=False):
    ...
    if offset != "":
        ...
        btn.insert(0,
            [InlineKeyboardButton(text="⭕️ Join Our Channel ⭕️",url="https://t.me/+_n5WfFVMoadmOTY9")]
        )
    else:
        btn.append(
